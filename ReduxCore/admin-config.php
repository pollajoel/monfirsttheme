<?php
	...
	Redux::setSection( $opt_name, array(
        ...
        //'icon'  => 'el el-home'
        'subsection' => true,
        'desc'       => __( 'you can add your custom code here: ', 'redux-framework-demo' ) . '',
        'fields'     => array(
            array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'Firstbgclor',
                'type'     => 'color',
                'title'    => __( 'First Footer Background Color', 'redux-framework-demo' ),
			...
			array(
                ...
                'subtitle' => __( 'Pick a First footer color (default: #dd9933).', 'redux-framework-demo' ),
                'default'  => '#dd9933',
                'validate' => 'color',
            ),
			...
			array(
                'id'       => 'secondfbclor',
                'type'     => 'color',
                'title'    => __( 'Second Footer Background Color', 'redux-framework-demo' ),
                'subtitle' => __( 'Pick a  color for the footer (default: #dd9933).', 'redux-framework-demo' ),
                'default'  => '#dd9933',
                'validate' => 'color',
            ),
        ),
